...
namespace SeleniumWebDriverBasics.WebObjects
{
    public class BaseElement : IWebElement
    {
        ...
        public IWebElement GetElement()
        {
            try
            {
                element = Browser.Driver.FindElement(this.locator);
            }
        ...
        {
            return Browser.Driver.FindElements(this.locator);
        }

        public void WaitForIsVisible()
        {
            new WebDriverWait(Browser.Driver, TimeSpan.FromSeconds(10)).Until(ExpectedConditions.ElementIsVisible(this.locator));
        }
        ...
        {
            WaitForIsVisible();
            Browser.Driver.FindElement(this.locator).SendKeys(text);
        }
        ...
        {
            WaitForIsVisible();
            return Browser.Driver.FindElements(this.locator).Count();
        }
